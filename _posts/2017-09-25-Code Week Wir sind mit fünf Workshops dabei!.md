...
<ul>
 	<li>8.10. - Websites selbst programmieren: Bau dir deine eigene Website. Designe deine HTML Website mit CSS und binde eine erste SQL Tabelle via PHP ein.</li>
 	<li>11.10. - 3D-Modelle programmieren mit OpenSCAD: OpenSCAD ist eine Programmiersprache, mit der 3D-Modelle konstruiert werden können. Wir werden verrückte mathematische Formeln ausprobieren, mit denen sich faszinierende 3D-Objekte erstellen lassen.</li>
 	<li>13.10. - Luftqualität: Ein Workshop zum selber messen: Wir bauen uns einen Luftsensor und vermessen unsere Umwelt.</li>
 	<li>14.10. - Pflanzenüberwachung mit Arduino: Marcel stellt ein automatisches Bewässerungssystem vor und hilft euch beim Eigenbau.</li>
 	<li>18.10. - LaTeX für Einsteigende: Jannik gibt euch eine Einführung in das coding-basierte Schreibprogramm "LaTeX".</li>
 	<li>19.10. - Alternative Betriebssysteme für das Smartphone: Wie bekommt ihr euer Smartphone frei von Google? Christian zeigt euch ein paar Alternativen.</li>
 	<li>20.10. - Vom physikalische Ereignis zum Datensatz: Wie entstehen Daten und wie arbeiten dann Geräte mit ihnen? Maximilian baut mit euch einen Temperatursensor.</li>
 	<li>21.10. - Audiogesteuerte Lichter: Marcel baut mit euch eine Lichtanlage, die durch Musik ihr Verhalten verändert.</li>
</ul>
